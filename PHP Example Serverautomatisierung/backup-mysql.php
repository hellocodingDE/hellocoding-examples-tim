...
function EXPORT_DATABASE($host,$user,$pass,$name,       $tables=false, $backup_name=false)
{
  ...
  if($tables !== false) {
	...
	ob_get_clean();
  if ($backup_name !== false) {
    file_put_contents($backup_name."db-backup_".$name."_date_".date("Y.m.d")."_time_".date("H.i.s")."_.sql", $content);
  }
  return $content;
...
EXPORT_DATABASE("localhost", "uvulpos", "password", "mysql", false, "backupdateiname");
?>
